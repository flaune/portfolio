    ...
    <div className="flex flex-col items-center gap-1 group flex-shrink-0">
      <motion.div
        ...
        className={cn(
          ...
          !isDark && "bg-[#FAF9F6] shadow-[0_5px_10px_rgba(0,0,0,0.15)] border border-[#EAD477]/50 hover:bg-[#EAD477]/20",
          isDark && "bg-black/60 border border-blue-500/30 shadow-[0_0_15px_rgba(0,100,255,0.3)] hover:bg-blue-500/20 hover:shadow-[0_0_25px_rgba(0,100,255,0.5)]"
        )}
        whileTap={{ scale: 0.9 }}
      >
        <Icon 
      ...
      {!isMobile && (
        <div className={cn(
          "absolute -top-12 px-3 py-1 rounded-md text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap",
